...
import { UPLOAD_SLIDER_BTN } from '../../../constants/dashboard'

import { deleteImage, uploadImage } from '../../../actions/dashboard'
    ...
    return (
        <Fragment>
            ...
            <div className="grid grid-cols-1 md:grid md:grid-cols-2 lg:grid-cols-3 my-4">
                {data.sliderImages.length ? data.sliderImages.map((item, index) => (
                    <div key={index} className="relative col-span-1 m-2 border">
                        <img
                            ...
                            alt="sliderImages"
                        />
                        <span onClick={() => dispatch(deleteImage(item._id))} style={{ background: "#303031" }} className="absolute top-0 right-0 m-1 text-white cursor-pointer rounded-full p-1">
        ...
        <Fragment>
            <div className="relative m-4 bg-white p-4 shadow-lg">
                ...
                <div className="relative flex flex-col space-y-2">
                    <div style={{ background: "#303031", width: 'max-content' }} className="relative z-0 px-10 py-2 rounded text-white flex justify-center space-x-2 md:w-4/12 cursor-pointer">
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input
                        ...
                        className="absolute z-10 opacity-0 cursor-pointer bg-gray-100"
                        type="file"
                        id="image"
                    />
                </div>
